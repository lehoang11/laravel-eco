...
require('app/Http/Controllers/Backend/Data/Data.php');

if(!isset($data_index)) {
    die("<font color='red'>[Backend ERROR]</font> You need to provide a data_index variable");
}

if(array_key_exists($data_index, $data)) {
    $data = $data[$data_index];
} else {
    die("<font color='red'>[Backend ERROR]</font> data_index '" . $data_index . "' does not have any existing data on it (the key does not exist), check: app/Http/Controllers/Admin/Data/Data.php");
}
...
if(array_key_exists('table', $data)) {
    ...
    die("<font color='red'>[Backend ERROR]</font> data_index '" . $data_index . "' does not have any existing table name 'table' key, check: app/Http/Controllers/Admin/Data/Data.php");
}
