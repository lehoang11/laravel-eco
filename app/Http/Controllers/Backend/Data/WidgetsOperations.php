...
$latest_users_graph['element_label'] = trans('backend.users_total_users');
$latest_users_graph['title'] = trans('backend.users_graph1');
...
$latest_posts_graph['element_label'] = trans('Backend.posts_new_posts');
$latest_posts_graph['title'] = trans('Backend.posts_graph3');
...
$roles_users['element_label'] = trans('Backend.users');
$roles_users['title'] = trans('Backend.roles_graph1');
...
$users_country_pie_graph['title'] = trans('backend.users_graph2');
$users_country_pie_graph['labels'] = [];
$users_country_pie_graph['data'] = [];
foreach($g_labels as $g_label){
    array_push($users_country_pie_graph['labels'],$countries[$g_label]);
    array_push($users_country_pie_graph['data'], count(Backend::users('country_code', $g_label)) );
}
...
$users_country_geo_graph['title'] = trans('backend.users_graph2');
$users_country_geo_graph['element_label'] = trans('backend.users');
$users_country_geo_graph['data'] = [];
foreach($g_labels as $g_label){
    array_push($users_country_geo_graph['data'], [$g_label, count(Backend::users('country_code', $g_label))] );
}
