...
<head>
	...
	<title>{{ trans('backend.download') }} {{ $file->name }} - {{ backend::settings()->website_title }}</title>
...
<body style="background-color: #EEEEEE;">
	...
	@endif
        ...
        <div style="padding-top: 100px;">
            <center>
                <img class="ui medium image" src="@if(Backend::settings()->logo) {{ Backend::settings()->logo }} @else {{ Backend::BackendLogo() }} @endif">
            </center>
        </div>
        <div style="padding-top: 100px;">
                        ...
                        <center>
                            ...
                            @else
                                ...
                                <form method="POST" id="download_form">
                                    ...
                                    @if($file->password)
                                        <div class="ui input">
                                            <input name="password" type="password" placeholder="{{ trans('Backend.document_password') }}">
                                        </div><br><br><br>
                                    @endif

                                    <div id="download_button">
                                        <button class="ui button" type="submit">{{ trans('backend.download') }}</button>
                                    </div>
                                </form>
                                <span id="download_starting"><br>{{ trans('backend.download_starting') }}</span>
                            @endif
                        </center>
                    </div>
				</div>
