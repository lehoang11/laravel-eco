  ...
  <div class="col-lg-12">
        <div class="box">
            <header>
               ...
               <h5> <a href="{{ route('backend::cates')}}" ><i class="fa fa-bars" aria-hidden="true"></i>&nbsp; Category edit </a></h5>
            </header>
...
<div class="col-lg-8">
 ...
 <option value="0">Cate Parent</option>
      <?php 
        Backend::MenuMulti($parent,0,"--",$row["parent_id"]);
        ?>
   </select>
</div>
</div>
